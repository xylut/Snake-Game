...
public class SnakePanel extends JPanel implements ActionListener{
	...
	static final int SQUARES = (SCREEN_WIDTH*SCREEN_HEIGHT)/(UNIT_SIZE*UNIT_SIZE);
	...
	public void newApple(){
		int tempAppleX = random.nextInt((int)(SCREEN_WIDTH/UNIT_SIZE))*UNIT_SIZE;
		int tempAppleY = random.nextInt((int)(SCREEN_HEIGHT/UNIT_SIZE))*UNIT_SIZE;
		for(int i = 0 ; i < x.length ; i++){
			if(tempAppleX == x[i] && tempAppleY == y[i]){
				newApple();
			}
		}
		appleX = tempAppleX;
